...
const HeroText = () => {
const  words=["Developer", "Programmer", "Inventor"];
 const variants = {
    ...
    return (
     <div className="z-10 mt-20 text-center md:mt-40 md:text-left rounded-3xl bg-clip-text">
       ...
       <div className="flex- flex-col space-y-6 md:hidden ">
        <motion.p className="text-4xl font-medium" variants={variants} initial="hidden" animate="visible"
        transition={{ delay: 1}}>Hello </motion.p>
        <div>
