export const myProjects = [
    ...
    tags: [
      {
        id: 1,
        name: "python",
        path: "/logos/python5.svg",
      },
      {
        id: 2,
        name: "numpy",
        path: "/logos/numpy.svg",
      },
      {
        id: 3,
        name: "OpenCV2",
        path: "/logos/opencv.png",
      },
      {
        id: 4,
        name: "imutils",
        path: "/logos/imutils.png",
      },
    ],
  },
  {
 ...
 "Preprocessed and cleaned seismic datasets with pandas and numpy for accurate modeling.",
   ...
   "Visualized model results and feature importances with matplotlib and seaborn for interpretability.",
    ...
    coverImage: "/logos/earthquake.jpg", 
    tags: [
      {
        id: 1,
        name: "pandas",
        path: "/logos/pandas.svg",
      },
      {
        id: 2,
        name: "numpy",
